...
| ((((['0'-'9'])+ (('.') (['0'-'9'])+)?) | (('.') (['0'-'9'])+)) (('e') ('-')? (['0'-'9'])*)? | ('0') (['b' 'B']) (['0'-'1'])* | ('0') (['o' 'O']) (['0'-'7'])* | ('0') (['x' 'X']) (['0'-'9' 'a'-'z' 'A'-'Z'])*) as x {ignore x; NUMBER( js_float_of_string x )} (* Number : float (len = 2) (kw = false) *)
...
| (('.')) as x {ignore x; EXPR1_22_1(x)} (* Expr1_22_1 : char (len = 1) (kw = false) *)
| (('(')) as x {ignore x; EXPR1_21_1(x)} (* Expr1_21_1 : char (len = 1) (kw = false) *)
| ("log") as x {ignore x; EXPR1_20_2(x)} (* Expr1_20_2 : string (len = 2) (kw = false) *)
| ("console") as x {ignore x; EXPR1_20_0(x)} (* Expr1_20_0 : string (len = 2) (kw = false) *)
| ((':')) as x {ignore x; EXPR1_19_3(x)} (* Expr1_19_3 : char (len = 1) (kw = false) *)
| (('?')) as x {ignore x; EXPR1_19_1(x)} (* Expr1_19_1 : char (len = 1) (kw = false) *)
| ("||") as x {ignore x; EXPR1_18_1(x)} (* Expr1_18_1 : string (len = 2) (kw = false) *)
| ("&&") as x {ignore x; EXPR1_17_1(x)} (* Expr1_17_1 : string (len = 2) (kw = false) *)
| ("!==") as x {ignore x; EXPR1_16_1(x)} (* Expr1_16_1 : string (len = 2) (kw = false) *)
...
| (('<')) as x {ignore x; EXPR1_12_1(x)} (* Expr1_12_1 : char (len = 1) (kw = false) *)
| ("<=") as x {ignore x; EXPR1_11_1(x)} (* Expr1_11_1 : string (len = 2) (kw = false) *)
| (('-')) as x {ignore x; EXPR1_10_1(x)} (* Expr1_10_1 : char (len = 1) (kw = false) *)
| (('+')) as x {ignore x; EXPR1_9_1(x)} (* Expr1_9_1 : char (len = 1) (kw = false) *)
| (('/')) as x {ignore x; EXPR1_8_1(x)} (* Expr1_8_1 : char (len = 1) (kw = false) *)
| (('*')) as x {ignore x; EXPR1_7_1(x)} (* Expr1_7_1 : char (len = 1) (kw = false) *)
| (('!')) as x {ignore x; EXPR1_6_0(x)} (* Expr1_6_0 : char (len = 1) (kw = false) *)
| (('=')) as x {ignore x; STMT_2_1(x)} (* Stmt_2_1 : char (len = 1) (kw = false) *)
| (":value") as x {ignore x; SEXP2_3_1(x)} (* Sexp2_3_1 : string (len = 2) (kw = false) *)
| (":expr") as x {ignore x; SEXP2_2_1(x)} (* Sexp2_2_1 : string (len = 2) (kw = false) *)
| (":program") as x {ignore x; SEXP2_1_1(x)} (* Sexp2_1_1 : string (len = 2) (kw = false) *)
| ((']')) as x {ignore x; IDENTS_0_2(x)} (* Idents_0_2 : char (len = 1) (kw = false) *)
| (('[')) as x {ignore x; IDENTS_0_0(x)} (* Idents_0_0 : char (len = 1) (kw = false) *)
| (":test") as x {ignore x; START_2_0(x)} (* Start_2_0 : string (len = 2) (kw = false) *)
| (":sexp") as x {ignore x; START_1_0(x)} (* Start_1_0 : string (len = 2) (kw = false) *)
